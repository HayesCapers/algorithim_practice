...
function straight(array){
	var success = sortArray(array);
	for (let i = 0; i < success.length-1; i++){
		var current = success[i];
		var next = success[i+1];
		if(next == current + 1){
			continue
		}else{
			return false
...
// console.log(findRank(testHand));


// var test =['H','H','H','H','H'];
// var testFalse = ['H','H','D','S','C'];
// console.log(flush(test));
// console.log(flush(testFalse));
// console.log(fullHouse(test))
// console.log(fullHouse(testFalse))
// console.log(twoPair(test));
// console.log(twoPair(testFalse));
// console.log(test);
// console.log(testFalse)
// console.log(sortArray(testFalse))
// console.log(cardValue.indexOf('T'))